...
%% 2. 创建图形窗口
figure('Name', '3D网格曲面图', 'Position', [100, 100, 900, 700], 'Color', 'w');
...
% shading interp;           % 网格图不需要平滑着色
% alpha(0.9);               % 网格图不需要设置透明度
...
%% 7. 设置标题
title('3D网格曲面图示例', 'FontSize', 14, 'FontWeight', 'bold', 'FontName', 'Microsoft YaHei');
...
%% 11. 保存图形
% saveas(gcf, '3D网格曲面图.png');
% saveas(gcf, '3D网格曲面图.fig');
% print(gcf, '3D网格曲面图', '-dpng', '-r300'); % 高分辨率保存
